...
class EvaluateModel:
    ...
    def __init__(self,model, evaluateForTrain = True):
        ...
        print('Evaluating Recommender Model : ',self.model.GetModel())
        ...
        if self.evaluateForTrain:
            ...
            if self.model.GetModel() != 'Content-Based' and self.model.GetModel() != 'Popularity':
    ...
    def GetUserNotRatedSample(self, UserId):
        ...
        RatedMovies = set(self.model.movieData.ratingsTrain.set_index('userId')\
                                                      .loc[UserId]['movieId'])
    ...
    def VerifyHit(self,MovieId,Recommendations,N):
        ...
        #if Index != -1:
        #    print('Debug - Combined List',Recommendations,\
        #          '|Index:',Index,'hit:',hit)
        return hit, Index
    ...
    def EvaluateRecommenderforUser(self,UserId):
        ...
        for row in UserEvalDataSet.itertuples():
            ...
            #print('Movie ID:',MovieId,'|Rating:',MovieRating)
            ...
            ValidatedRecommendations = \
                UserRecommendations[UserRecommendations['movieId']\
                                    .isin(CombinedSet)]['movieId'].to_numpy()
            ...
            Hit10Count += Hit10
            #if Rank > -1:
            #    print('Debug - Hit Counts')
            #    print('Hit5Count:',Hit5Count,'|Hit10Count:',Hit10Count)
    ...
    def EvaluateRecommenderModel(self):
        ...
        for UserId in self.ratingsTest.set_index('userId').index.unique()\
        ...
        #                                       .to_numpy())):
            ...
            #print('Debug - User Metric')
            #print(UserMetricforModel)
